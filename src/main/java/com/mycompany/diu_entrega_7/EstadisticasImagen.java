...
public class EstadisticasImagen {
    ...
    public String toString() {
        String s = "Valores mínimos:\n";
        s += "\tRojo: " + this.getMinimo()[0] + "\n";
        s += "\tVerde: " + this.getMinimo()[1] + "\n";
        s += "\tAzul: " + this.getMinimo()[2] + "\n";

        s += "\nValores máximos: \n";
        s += "\tRojo: " + this.getMaximo()[0] + "\n";
        s += "\tVerde: " + this.getMaximo()[1] + "\n";
        s += "\tAzul: " + this.getMaximo()[2] + "\n";

        s += "\nValores promedios: \n";
        s += "\tRojo: " + this.getPromedio()[0] + "\n";
        s += "\tVerde: " + this.getPromedio()[1] + "\n";
        s += "\tAzul: " + this.getPromedio()[2] + "\n";
        return s;
    }
}
